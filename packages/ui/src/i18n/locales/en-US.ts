...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like UWork to show its work?",
  "occupationOnboarding.coding": "Developer",
  ...
  "occupationOnboarding.officeMode": "Assistant",
  ...
  "chat.officeSuggestions.settingDescription": "Available only in Assistant.",
  ...
  "occupationOnboarding.memoryDescription": "Let UWork remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting UWork",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen UWork.",
  ...
  "startup.global.starting_services": "Starting UWork",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "UWork will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another UWork or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen UWork. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen UWork to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen UWork.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a UWork restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into UWork",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to UWork and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to UWork",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to UWork",
  "login.description": "Connect your account to start using UWork",
  ...
  "logout.confirm.title": "Disconnect and restart UWork?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only UWork Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About UWork",
  ...
  "forceUpdate.title": "Update UWork to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart UWork to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the UWork CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "UWork checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.interfaceMode.description":
    "Assistant focuses on summaries and results. Developer shows commands, output, and code changes.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the UWork terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While UWork is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the UWork installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching UWork task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by UWork",
  ...
  "resourceManager.storage.diskUsage": "UWork uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the UWork desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "UWork could not verify its Windows secure import component. Reinstall or update UWork before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, UWork will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by UWork Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "UWork provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This UWork Agent cannot refresh OAuth status. Upgrade or restart UWork, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to UWork to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into UWork",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to UWork 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by UWork automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in UWork.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. UWork uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.modelProvider.discoveryFailed": "Could not fetch models. Please retry.",
  "settings.modelProvider.discoveryEmpty": "No models returned",
  "settings.modelProvider.discoveryResult":
    "Found {discovered}, added {added}, already configured {skipped}",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in UWork after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "UWork MCP",
  ...
  "sidebar.usage.plan.mcp": "UWork MCP",
  "sidebar.usage.plan.zcodeMcp": "UWork MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for UWork built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into UWork. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. UWork follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into UWork",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by UWork Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend UWork with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into UWork and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. UWork follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into UWork",
  ...
  "settings.commands.description":
    "Manage UWork Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "UWork Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into UWork. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. UWork follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into UWork",
  ...
  "settingsSync.action.finish": "Start using UWork",
  "settingsSync.agent.zcode": "UWork Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current UWork settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to UWork",
  ...
  "onboarding.welcome.title": "Welcome to UWork",
  "onboarding.welcome.start": "Start UWork",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while UWork imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "UWork will copy {source} to {target}.\nIf the target file already exists, the UWork default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask UWork anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask UWork anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, UWork will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want UWork to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart UWork app and retry, or ask UWork to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with UWork in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for UWork: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with UWork in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current UWork Agent session",
  ...
  "chat.error.noAvailableModel": "No model available. Add a custom provider in Model Settings.",
  ...
  "chat.quota.mcp.quotaExhausted":
    'UWork MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No UWork MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "UWork",
  ...
  "feedback.submit.template.section.copyErrorHeading": "UWork Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while UWork is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task UWork can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "UWork Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "UWork Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart UWork",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart UWork to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified UWork plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "UWork will verify the Computer Use tools against the exact session when your first session starts.",
